<?php
include '../../include/functionsPhp/toIncludeAfterConnection.php';

if (!$redirectToIndex) {

include "../../include/elementsHtml/header.php";

includeRightHeader('<a href="../../assets/scripts/PHP/logOut.php"><i class="fa fa-power-off" aria-hidden="true"></i>log&nbsp;out</a>');
